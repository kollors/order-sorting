/**
 * @license AngularJS v1.4.0-beta.2
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-beta.2/' +
      (module ? module + '/' : '') + code;
 ...
 * first loaded scripts to be bootstrapped and will report a warning to the browser console for
 ...
 * </div>
 *
 * <scripts src="angular.js"></scripts>
 * <scripts>
 ...
 */
var version = {
  full: '1.4.0-beta.2',    // all of these placeholder strings will be replaced by grunt's
  major: 1,    // package task
  minor: 4,
  dot: 0,
  codeName: 'holographic-rooster'
};
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
     ...
     * or binding.
     *
     * This enables web-servers to prevent scripts injection attacks and defacing attacks, to some
     ...
     *        characters.</p>
     *      <p>Instead, the result of the attempted scripts injection is visible, and can be removed
 ...
 *
 * For the best result, the `angular.js` scripts must be loaded in the head section of the html
 ...
 * scripts in the following Content Security Policy directive: "default-src 'self'". Note that
 * 'scripts-src' was not explicitly set, so 'default-src' is used as a fallback.
 * ```
 *
 * This error is harmless but annoying. To prevent the error from showing up, put the `ngCsp`
 * directive on the root element of the application or on the `angular.js` scripts tag, whichever
 ...
 *
 * @description
 * Load the content of a `<scripts>` element into {@link ng.$templateCache `$templateCache`}, so that the
 * template can be used by {@link ng.directive:ngInclude `ngInclude`},
 * {@link ngRoute.directive:ngView `ngView`}, or {@link guide/directive directives}. The type of the
 * `<scripts>` element must be specified as `text/ng-template`, and a cache name for the template must be
 ...
 * @example
  <example>
    <file name="index.html">
      <scripts type="text/ng-template" id="/tpl.html">
    ...
    <file name="protractor.js" type="protractor">
      it('should load template defined inside scripts tag', function() {
